...
with recursive src as (
    select
        site_code,
        breakdown,
        campaign_prior_total_multiorder_unit,
        campaign_prior_total_multiorder,
        campaign_prior_total_multiorder_revenue,
        scom_prior_total_multiorder_unit,
        scom_prior_total_multiorder,
        scom_prior_total_multiorder_revenue,
        start_date,
        end_date
    from nyny_multipurchase_260211_prior
),
split_seed as (
    select
        site_code,
...
unpivoted as (
    select distinct 
        ...
        campaign_prior_total_multiorder_unit as unit,
        campaign_prior_total_multiorder as `order`,
        campaign_prior_total_multiorder_revenue as revenue,
        start_date,
        end_date
    from exploded
    union all
