-- source: 홈아이디어 랜딩(오가닉 파악) 쿼리문 231206 / 택주님 원본 (2023-11)
-- LAG로 직전 url 유무를 판단해 홈아이디어 상세 페이지의 랜딩(오가닉 유입) pcid/세션 수 산출 (원본)
...
FROM A
WHERE url_path LIKE "%https://mall.hanssem.com/m/homeIdea/contents/homeIdeaDetail.do%" -- 검색할 URL_path 값
