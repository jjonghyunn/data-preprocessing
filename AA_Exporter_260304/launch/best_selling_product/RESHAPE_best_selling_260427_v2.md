...
<sub>2026-05-06  Jonghyun Park w/ Claude</sub>  
...
| 한 raw 행 → 출력 | 2줄 (Shop / Campaign) | **4줄** (Web Shop / Web Campaign / App Shop / App Campaign) |
...
aa_exports/{tb_key}_*.csv
    ...
    │
    ├─ Web Shop    : STANDARD="Shop",    WEB/APP="WEB", ORDER=value1, REVENUE=value2×rate
    ├─ Web Campaign : STANDARD="Campaign", WEB/APP="WEB", ORDER=value3, REVENUE=value4×rate
    ├─ App Shop    : STANDARD="Shop",    WEB/APP="APP", ORDER=value5, REVENUE=value6×rate
...
| `ORDER` | Web Shop=`value1`, Web Campaign=`value3`, App Shop=`value5`, App Campaign=`value7` |
...
| TIER 컬럼 | 현재 공란으로 고정 |
| 출력 행수 | raw 행수 × 4 (Web Shop / Web Campaign / App Shop / App Campaign) |
