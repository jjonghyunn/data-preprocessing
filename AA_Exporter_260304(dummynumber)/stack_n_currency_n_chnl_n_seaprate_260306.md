...
2. stack_n_currency_n_chnl_n_seaprate_260306.ipynb 파일을 실행한다.
...
- ✅ 정상: 매핑 컬럼 완전 일치
- ⚠️ 일부 누락: 매핑에 있는 컬럼 일부가 CSV에 없음 (에러 아님, 무시됨)
- 🔴 전혀 불일치: value_vars=[] → metric_name KeyError 원인
- ❌ 매핑 없음: skip 대상
