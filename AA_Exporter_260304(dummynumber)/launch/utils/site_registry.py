...
_SITE_MASTER: dict[str, tuple[str | None, str | None, str]] = {
    ...
    "hk_en": ("SEHK", "HongKong (English)", "company_rsid_hken"),
    "tw": ("SET", "Taiwan", "company_rsid_tw"),
    "az": ("SERC", "Azerbaijan", "company_rsid_az"),
    "kz_ru": ("SECE", "Kazakhstan (Russian)", "company_rsid_kzru"),
    "kz_kz": ("SECE", "Kazakhstan (Kazakh)", "company_rsid_kzkz"),
    ...
    "uz_ru": ("SEUZ", "Uzbekistan (Russian)", "company_rsid_uzru"),
    "uz_uz": ("SEUZ", "Uzbekistan (Uzbekistan)", "company_rsid_uzuz"),
    "africa_en": ("SCA", "Africa Pan (en)", "company_rsid_africaen"),
    "africa_fr": ("SCA", "Africa Pan (fr)", "company_rsid_africafr"),
    ...
    "levant_ar": ("SELV", "Levant (ar)", "company_rsid_levantar"),
    "africa_pt": ("SCA", "Africa Pan (pt)", "company_rsid_africapt"),
    ...
    "ae_ar": ("SGE", "UAE (ar)", "company_rsid_aear"),
    "sa_en": ("SESAR", "Saudi Arabia (en)", "company_rsid_saen"),
    "za": ("SSA", "South Africa", "company_rsid_za"),
    "lb": ("SELV", "Lebanon", "company_rsid_lb"),

    # --- Europe etc ---
    "at": ("SEAS", "Austria", "company_rsid_at"),
    "be": ("SEBN", "Belgium(NL)", "company_vrs_be"),
    "be_fr": ("SEBN", "Belgium(FR)", "company_vrs_be"),
    ...
    "latin_en": ("SELA", "Panama (English)", "company_rsid_latinen"),
    "latin": ("SELA", "Panama (Spanish)", "company_rsid_latin"),
    ...
    "ca_fr": ("SECA", "Canada(FR)", "company_rsid_cafr"),
